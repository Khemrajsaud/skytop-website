...
// const Footer = () => {
//   return (
//     <div className="bg-sky-100 text-gray-700 py-10 px-6 text-center md:text-left">
//       <div className="max-w-6xl mx-auto">
//         <div className="flex flex-col items-center ml-[400px] md:items-start">
//           <h2 className="text-2xl font-bold text-gray-800 mb-4">Skytop</h2>
...
//             <FaLinkedinIn className="text-gray-600 hover:text-blue-500 cursor-pointer" />
...
const Footer = () => {
  return (
    <div className="bg-gradient-to-b from-sky-200 to-sky-100 text-gray-700 py-10 px-6">
      <div className="max-w-6xl mx-auto">
