...
const Navbar = () => {
  ...
  return (
    ...
    //         <div className="flex items-center gap-3 bg-blue-400 p-3 rounded-lg">
    //           <a href="#" className="text-white text-lg hover:opacity-75">
    //             <FaFacebookF className="bg-blue-600 rounded-full p-2 w-10 h-10" />
    //           </a>
    //           <span className="text-white">|</span>
    //           <a href="#" className="text-white text-lg hover:opacity-75">
    //             <FaXTwitter className="bg-black rounded-full p-2 w-10 h-10" />
    //           </a>
    //           <span className="text-white">|</span>
    //           <a href="#" className="text-white text-lg hover:opacity-75">
    //             <FaLinkedinIn className="bg-blue-500 rounded-full p-2 w-10 h-10" />
    //           </a>
    //           <span className="text-white">|</span>
    //           <a href="#" className="text-white text-lg hover:opacity-75">
    //             <FaInstagram className="bg-red-500 rounded-full p-2 w-10 h-10" />
    //           </a>
    //           <span className="text-white">|</span>
    //           <a href="#" className="text-white text-lg hover:opacity-75">
    //             <FaTiktok className="bg-black rounded-full p-2 w-10 h-10" />
    //           </a>
    //         </div>
    //       </div>
    //     </div>
    ...
    //       <img src={skytop} alt="" className="w-[250px]" />
    //     </div>
    ...
    //       <Link to="/program" className="hover:text-blue-500" onClick={() => setIsOpen(false)}>Program</Link>
    //       <Link to="/gallery" className="hover:text-blue-500" onClick={() => setIsOpen(false)}>Gallery</Link>
    //       <Link to="/news" className="hover:text-blue-500" onClick={() => setIsOpen(false)}>News & Media</Link>
...
<div>
      ...
      <div className="bg-white shadow-md py-2 px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6 text-black font-medium">
          ...
          <Link to="/programs"className="hover:text-blue-500">Program</Link>
          <Link to="/gallery" className="hover:text-blue-500">Gallery</Link>
          <Link to="/news" className="hover:text-blue-500">News & Media</Link>
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col bg-white shadow-lg p-4 space-y-4">
          ...
          <Link to="/gallery" className="hover:text-blue-500" onClick={() => setIsOpen(false)}>Gallery</Link>
          <Link to="/news" className="hover:text-blue-500" onClick={() => setIsOpen(false)}>News & Media</Link>
          <Link to="/contacts" className="hover:text-blue-500" onClick={() => setIsOpen(false)}>Contact Us</Link>
        </div>
      )}
    </div>
